...
#### Hint
Use a fast and slow pointer to find the middle, reverse the second half, and compare.

#### Brute Force
- Copy linked list to array and check palindrome.
- **TC:** O(n) | **SC:** O(n)
...
- Find middle, reverse second half, compare first and second halves.
- **TC:** O(n) | **SC:** O(1)
